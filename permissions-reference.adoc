...
.2+| Gestion des entrées et sorties de groupes de sécurité pour un système de fichiers FSX pour ONTAP | ec2 : RevokeSecurityGroupIngress | Les opérations de gestion | Création et suppression de systèmes de fichiers 


| ec2:DeleteSecurityGroup | Les opérations de gestion | Création et suppression de systèmes de fichiers 


.17+| Créez, affichez et gérez les ressources du système de fichiers FSX pour ONTAP | fsx:CreateVolume | Les opérations de gestion | Opérations et assainissement 
