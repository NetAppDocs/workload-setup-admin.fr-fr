...
L'autorisation suivante est maintenant disponible en _read_ mode pour les bases de données : `iam:SimulatePrincipalPolicy`. L'autorisation suivante est maintenant disponible en _automate_ mode pour GenAI: `bedrock:GetFoundationModel`.
