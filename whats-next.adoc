...
* https://docs.netapp.com/us-en/workload-builders/index.html["charges de travail du constructeur"^]
+
Simplifiez la consommation et l'accès aux versions logicielles en permettant une intégration instantanée des clones avec les systèmes de contrôle de version et les flux CI/CD, ce qui permet de gagner du temps et des ressources.
