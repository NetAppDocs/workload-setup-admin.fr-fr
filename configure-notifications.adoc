...
| Rapport mensuel des coûts | Récapitulatif mensuel des coûts de votre compte, présentant les tendances de dépenses, les variations inhabituelles et les meilleures opportunités d'économies pour les systèmes de fichiers FSx for ONTAP. | Rapport de coûts | Recommandation | Stockage général | FSx pour les systèmes de fichiers ONTAP 


| Délai de réplication | La réplication prend plus de temps que prévu. | Réplication | Primordial | Stockage général | FSx pour les systèmes de fichiers ONTAP 


| Création réussie du tableau de bord personnalisé | Votre tableau de bord personnalisé a été créé avec succès et est prêt à être consulté. | Tableaux de bord personnalisés | Réussite | Stockage général | Compte Workload Factory 


| La création du tableau de bord personnalisé a échoué | Workload Factory n'a pas pu créer votre tableau de bord personnalisé. Essayez de créer à nouveau le tableau de bord. | Tableaux de bord personnalisés | Erreur | Stockage général | Compte Workload Factory 
|===
